...
export default function Signup() {
  ...
  return (
    ...
    <div className="grid gap-6 mb-6 md:grid-cols-1">
        ...
        <TextInput label="Confirm Password" type="password" placeholder="•••••••••" required value={password} onChange = {(e) => setPassword(e.target.value)}/>
    ...
    <PrimaryButton text="Sign Up" type="button" onClick = {login} />
